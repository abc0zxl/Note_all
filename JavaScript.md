...
**创建了个构造函数的对象**，用对象中的**原型对象创建了方法**，原型对象中的**constructor**又指回了**原来的构造函数**
...
* 可以通过继承同内容**不同名字**的类来实现


# 原型链

1.**自定义构造函数的各个关系**：如上面__proto__**的关系**

2.**这个prototype也是个对象**：它内部也有个__proto__,这个指向的是Object的prototype

3.**再往上找__proto__就是null**
