...
* 点击自动生成数据的魔棒
* 设置好api，然后导入你要写成的数据对象的描述
* 然后就能自动生成了

  ![image.png](/assets/28a373a6-77d4-4b4d-98ec-5ed4085162df.png)
* **遇到生成不出来的，可以查看粘贴的文本是否有难以识别的东西，移除自己手动处理即可**
* **如果粘贴了已存在的参数，或者想在某个数组内生成 参数，也不用怕，他会自己处理好**
