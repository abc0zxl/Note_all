...
* 首先通过上面图片方式获取到的参数对象他的类型是未知的，所以无法对他操作，set，get方法都会报错
* 所以要用下图的方法类查找到该对象的方法和类型
* **Method**：然后用Method匹配这个对象和他的方法，为了通过编译。然后用method的对象来封装，这个类的方法，**但是没有这个方法的类**。
* **invoke**：调用这个method对象的invoke方法，声明**要执行的对象**和**要填入的数据**

![image.png](/assets/08c46a36-d70e-40f7-9a39-b894250a7064.png)
