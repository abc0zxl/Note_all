...
**作用**：在执行SQL的时候，能根据业务场景**动态替换表名**，不用重复定义多个sql，mapper方法

**场景**：

* **订单分表**：订单表由于过于庞大，被拆成多份的时候，就会有多个同结构不同名字的表。
* **多租户**：不同的租户有不同的情况
* **切换环境的时候**
...
![image.png](/assets/579b2a49-9343-4bf5-bfd2-5116a5a2c5d9.png)

2.**利用方法**：

**![image.png](/assets/be700c8b-718c-4ad5-a987-ac76ba135987.png)**

# 多租户

**作用**：各个用户之间的数据隔离，查找时，直接查找

# 数据据权限管理

# 代码生成

mybatis-plus可以利用**生成器**，可以生成
...
、![image.png](/assets/f799d2da-7540-4918-bc94-da1b51ea7539.png)
